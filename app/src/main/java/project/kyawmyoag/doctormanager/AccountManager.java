...
public class AccountManager extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final String role = details.get("role");
          ...
          if(role.equals("Manager")) {
              ...
              final ProgressDialog dialog = ProgressDialog.show(AccountManager.this, "လုပ်ဆောင်နေသည်...","စောင့်ပါ..." , true);
              dialog.show();
        ...
        change_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new FancyAlertDialog.Builder(AccountManager.this)
                        ...
                        .setMessage("စကားဝှက်ပြောင်းရန် သေချာပါသလား ?")
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    Toast.makeText(AccountManager.this, "စကားဝှက်ပြောင်းရန် အချက်အလက်များ သင့်အီးမေးလ်ထံပို့ပြီးပါပြီ!", Toast.LENGTH_SHORT).show();

                                                } else {
                                                    Toast.makeText(AccountManager.this, "အီးမေးလ်းပြောင်းခြင်းမအောင်မြင်ပါ!", Toast.LENGTH_SHORT).show();
                                                }
    ...
    private void uploadFile(){
        ...
        if(filePath != null)
        {
            ...
            progressDialog.setTitle("ဆောင်ရွက်နေသည်");
            progressDialog.show();
            ...
            sRef.putBytes(imageDataInByte)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(getApplicationContext(), "ဆောင်ရွက်ပြီးပါပြီ", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(getApplicationContext(), "ပုံတင်ခြင်းမအောင်မြင်ပါ",Toast.LENGTH_LONG ).show();
                        }
                    })
                    .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            progressDialog.setMessage("တင်နေဆဲ "+ (int)progress + "%...");
                        }
                    });
        }
        else
        {
            Toast.makeText(getApplicationContext(), "ပုံအရင်‌ရွေးပေးပါ!!", Toast.LENGTH_LONG).show();
        }
    }
}
