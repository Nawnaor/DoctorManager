                    ...
                    auth.createUserWithEmailAndPassword(email, password)
                            .addOnCompleteListener(SignUpSalesManager.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    Toast.makeText(SignUpSalesManager.this, "အောင်မြင်ပါသည်:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                    if (!task.isSuccessful()) {
                                        Toast.makeText(SignUpSalesManager.this, "မအောင်မြင်ပါ." + task.getException(),
